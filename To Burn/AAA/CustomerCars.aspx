<%@ Page Title="My Cars Page" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="CustomerCars.aspx.vb" Inherits="CustomerCars" %>

<asp:Content ID="ContentCustomerCars" ContentPlaceHolderID="ContentPlaceHolderHome" Runat="Server">

<div id="contCust"> 
       
       <p>
            <h1> My Cars for sale at A & A Autotrading Limited </h1>

            <h2> <asp:Label ID="lblNotLogged" runat="server" Text="Label" Visible="false"></asp:Label> </h2>
       </p>
