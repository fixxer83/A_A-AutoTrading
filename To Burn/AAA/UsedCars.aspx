<%@ Page Title="Used Cars Page" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="UsedCars.aspx.vb" Inherits="UsedCars" %>

<asp:Content ID="ContentUsedCars" ContentPlaceHolderID="ContentPlaceHolderHome" runat="server">
       
   <div id="contUsed"> 

       <p>
            <h1> Used Cars for sale at A & A Autotrading Limited </h1>
       </p>
