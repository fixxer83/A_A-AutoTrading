<%@ Page Title="Car Search Page" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="CarSearch.aspx.vb" Inherits="CarSearch" %>

<asp:Content ID="ContentCarSearch" ContentPlaceHolderID="ContentPlaceHolderHome" Runat="Server">

    <div id="contCarSrch">
       
            <h2><asp:Label Id="LblNoSearch" runat="server" Text="Label"></asp:Label></h2>
